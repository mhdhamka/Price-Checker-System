...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="searchAdmin.php" class="nav-item nav-link active"><i class="fa fa-search me-2"></i>Search Item</a>
        ...
        <div class="container-fluid pt-4 px-4">
            ...
            <form method="post" onsubmit="return validateForm()">
                ...
                <p><small><i>Please only input ItemID, ItemName, and ItemCategory only before clicking the search button</i></small></p>
            </div>
            <br>
            <div class="table-responsive">
                    ...
                    if ($search) {
                       ...
                       if ($result && mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo '<tr>
                            <td><center>' . $row['ItemID'] . '</td>
                            <td><center>' . $row['ItemName'] . '</td>
                            <td><center>' . $row['ItemPrice'] . '</td>
                            <td><center>' . $row['ItemCategory'] . '</td>
                            <td>' . $row['ItemDescription'] . '</td>
                            <td>' . $row['StoreName'] . '</td>
                            <td><center><img src="' . $row['ItemImage'] . '" style="width: 80%"></td>
                            </tr>';
                        }
                        echo '</tbody>';
                        } 
    ...
    function validateForm() {
        var searchInput = document.getElementById('searchtextbox').value.trim();
        if (searchInput === '') {
