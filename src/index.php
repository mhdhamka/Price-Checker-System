        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="index.php" class="logo"><img src="assets/images/logo.png"  width="90" height="90"></a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
        ...
        <div class="video-overlay header-text">
            ...
            <h2>Welcome to the</h2>
                ...
                <div class="main-button scroll-to-section">
                    <a href="loginSelection.php">Register Now</a>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="section-heading dark-bg">
                        ...
                        <img src="assets/images/line-dec.png" alt="">
                        <p style = "color: #000000">This table displays items available in the system. Please log in to view, filter, and compare item details.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="table-responsive">
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        echo "<tr style='text-align: center; border-color: #000000; color: #000000;'>
                                            ...
                                            <td style='border-color: #000000; color: #000000;'><img src='".$row['ItemImage']."' style='width: 35%'></td>
                                        </tr>";
                                    }
                                }
                            ?>
                    ...
                    <br>
                    <div class="main-button scroll-to-section">
                    <center><a href="loginSelection.php">Register to Filter & Compare</a>
                    </div>
                </div>
            </div>
        </div>
...
<section class="section" id="search">
    <div class="container">
        ...
        <br>
        <div class="main-button scroll-to-section">
            <center><a href="loginSelection.php">Register to search item</a></center>
        </div>
        <br>
    </div>
    </section>
