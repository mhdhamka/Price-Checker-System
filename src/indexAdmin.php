            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Manage Item Details</h6>
                    </div>
									...
									if ($result -> num_rows > 0)
									{
										while ($row = $result -> fetch_assoc())
										{
											echo "<tr style = 'text-align: center;'>
                                                    ...
                                                    <td>".$row['StoreName']."</td>
                                                    <td><img src = ".$row['ItemImage']." style = 'width: 80%'></td>
													<td>
                                                       <button class='btn btn-primary'style = 'background-color: white'><a href=\"updateItem.php?updateID=$row[ItemID]\">Update</a></button>
                                                       <br><br>
												       <button class='btn btn-primary'style = 'background-color: white'><a href=\"deleteItem.php?deleteID=$row[ItemID]\">Delete</a></button>
                                                    </td>
												 </tr>";
										}
									}
                    ...
                    <br>
                    <button type="submit" class="btn btn-primary" style = "background-color: white"><a href = "addItem.php" style = "font-color: white;">Add Item</a></button>
                </div>
            </div>
            <!-- Item details End -->
