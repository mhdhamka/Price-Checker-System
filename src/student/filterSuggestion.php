...
<div class='compare-suggestion-item'>
...
<div class="compare-suggestion-item" data-name="<?php echo htmlspecialchars($item['ItemName']); ?>">
    ...
    <img src="<?php echo $item['ItemImage'];?>">
        ...
        <div class="compare-suggestion-info">
            ...
            <!-- First Row -->
            <div class="compare-suggestion-header">
                ...
                <span class="compare-suggestion-price">
            ...
            <div class="compare-suggestion-category">
            ...
            <div class="compare-rating-box">
                ...
                <div class="compare-rating-score">
                ...
                <div class="compare-rating-review">
