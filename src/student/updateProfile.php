...
if (isset($_FILES['studentIMG']) && $_FILES['studentIMG']['error'] == 0) {
    ...
    $extension = strtolower(pathinfo($_FILES['studentIMG']['name'], PATHINFO_EXTENSION));
    ...
    if(in_array($extension,$allowed))
    {
        ...
        if(move_uploaded_file($_FILES['studentIMG']['tmp_name'],$targetFile))
        {
            $imagePath = "../../assets/images/profile/" . $newFileName;
        }
    }
}
