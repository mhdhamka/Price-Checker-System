        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
					...
					<a href="aboutus.php?editID=1" class="nav-item nav-link active"><i class="fa fa-user me-2"></i>About Us</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
						<h6 class="mb-0">Update About Us Details</h6>
                    </div>
										...
										if ($result -> num_rows > 0)
										{
											while ($row = $result -> fetch_assoc())
											{
												echo "<tr style = 'text-align: left;'>
														<td><center>".$row['aboutusID']."</td>
														<td><center>".$row['aboutusName']."</td>
														<td><center>".$row['aboutusCourse']."</td>
														<td><center>".$row['aboutusDetails']."</td>
														<td><center><img src = ".$row['aboutusIMG']." style = 'width: 100%'></td>
														<td>
															<button class='btn btn-primary'style = 'background-color: white'><a href=\"aboutus.php?editID=$row[aboutusID]\">Update</a></button>
														</td>
													 </tr>";
											}
										}
					...
					<div class="bg-secondary rounded h-100 p-4">
						...
						<?php
							global $conn;
							$editID = $_GET['editID'];
							$sql = "SELECT * FROM aboutus WHERE aboutusID = '$editID'";
							$result = mysqli_query($conn, $sql);
							...
							if ($result -> num_rows > 0)
							{
								while ($row = $result -> fetch_assoc())
								{
									$aboutusID = $_GET['editID'];
                                    $name = $row['aboutusName'];
                                    $course = $row['aboutusCourse'];
									$details = $row['aboutusDetails'];
								}
							}
						?>	 
                        <div class="row mb-3">
								<label for="inputFname" class="col-sm-2 col-form-label">ID</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="inputFname" name = "aboutusID" value = "<?php echo $aboutusID ?>" readonly>
								</div>
							</div>
							<div class="row mb-3">
                            ...
                            <div class="row mb-3">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="inputFname" name = "course" value = "<?php echo $course ?>">
								</div>
							</div>
							<div class="row mb-3">
								<label for="inputFname" class="col-sm-2 col-form-label">Details</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="inputFname" name = "details" value = "<?php echo $details ?>">
								</div>
							</div>
                            <div class="row mb-3">
							...
							<button type="submit" class="btn btn-primary" style = "background-color: white"><a href = "aboutus.php?editID=<?php echo $editID ?>" style = "font-color: white;">Cancel</a></button>
