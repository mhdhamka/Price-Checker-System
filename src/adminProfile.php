...
<?php
	...
	if (isset($_POST['submit']))
	{
		...
		{
			$sql = "UPDATE admin
					SET adminFullname = '$fullname', adminUsername = '$username', adminEmail = '$email', adminPassword = '$password'
		...
		else
		{
			...
			$sql = "UPDATE admin
					SET adminFullname = '$fullname', adminUsername = '$username', adminEmail = '$email', adminPassword = '$password', adminIMG = '$path'
					WHERE adminID = '$adminID'";
			mysqli_query($conn, $sql);
    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <a href="adminProfile.php" class="nav-item nav-link active"><i class="fa fa-user-cog me-2"></i>My Profile</a>
                ...
                <div class="center">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Update Admin Profile Information</h6>
                            <form method = "POST" action = "adminProfile.php" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
										...
										<input type="text" class="form-control" id="inputFname" name = "fullname" value = "<?php echo $fullname ?>">
                                    </div>
                                </div>
								<div class="row mb-3">
